configuration do |c|
	...
	# default value: "podio-desktop"
	#
	#c.project_name = "podio-desktop"
	...
	# default value: []
	#
	c.files_to_copy = ["img/logo.png", "img/logo_unread.png"]
	...
	# default value: nil
	#
	c.mac_icon_path = "img/logo.png"

	# Undocumented option 'windows_icon_path'
	# default value: nil
	#
	c.windows_icon_path = c.mac_icon_path
